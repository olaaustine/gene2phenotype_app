...
our %MESSAGES = (
  ...
  SELECTED_VARIANT_CONSEQUENCE => {msg => 'Variant consequence already selected', type => 'danger'},
  UPDATED_VAR_CON_SUCCESSFULLY => {msg => "Successfully updated variant consequence", type => 'success'},
  ...
  ADDED_PRIVATE_COMMENT_SUC => { msg => 'Successfully added a new private comment.', type => 'success'},
  ADDED_PUBLIC_COMMENT_SUC => { msg => 'Successfully added a new public comment.', type => 'success'},
